                ...
                case "Construct":
                    {
                        ...
                        AI.hatedFactions.Add("Drake");
                        AI.hatedFactions.Add("Evil-Humanoid");
                        AI.hatedFactions.Add("Cephalopod");
                        AI.hatedFactions.Add("Fish");
                        AI.hatedFactions.Add("Insect");
                        AI.hatedFactions.Add("Plant");
                        break;
                    }
                case "Broken-Construct":
                    {
                        AI.hatedFactions.Add("Undead");
                        AI.hatedFactions.Add("Elemental");
                        AI.hatedFactions.Add("Beast");
                ...
                case "Insect":
                    {
                        ...
                        AI.hatedFactions.Add("Evil-Humanoid");
                        AI.hatedFactions.Add("Player");
                        AI.hatedFactions.Add("Prey");
                        AI.hatedFactions.Add("Predator");
                        break;
                    }
                case "Drake":
                    {
