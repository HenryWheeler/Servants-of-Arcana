...
{
    [Serializable]
    public class HostAI : AIController
    {
        public List<Entity> body = new List<Entity>();
        public List<Entity> limbs = new List<Entity>();
        ...
        public HostAI(int baseInterest, int minDistance, int maxDistance, int abilityChance, int hate, int fear, int greed)
